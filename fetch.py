#!/usr/bin/env python3
"""
Recuperation des codes promo Size? depuis shopilo.fr
Sursa: https://shopilo.fr/reductions/sizeofficial.fr
"""
...
SHOPILO_URL = "https://shopilo.fr/reductions/sizeofficial.fr"
STORE_NAME = "Size?"


def fetch_coupons(url=SHOPILO_URL):
    """Renvoie la liste des coupons actifs pour Size? depuis shopilo.fr"""
    headers = {
        "User-Agent": "Mozilla/5.0 (compatible; coupon-fetcher/1.0; +https://github.com/shopilo-fr/code-promo-sizeofficial)"
    }
    try:
